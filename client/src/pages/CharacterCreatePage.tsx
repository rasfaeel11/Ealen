      ...
      <form onSubmit={handleSubmit} className="mx-auto max-w-3xl">
        <header className="mb-8 flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-2 font-garamond text-base leading-relaxed text-codex-inkDim">
        ...
        <section className="mb-8">
          <label className="flex flex-col gap-2">
            <div className="flex items-center justify-between">
              <span className="font-cinzel text-xs uppercase tracking-[0.3em] text-codex-inkDim">Nome</span>
              <button
                type="button"
                onClick={() => setName(randomCharacterName(race))}
                className="font-cinzel text-xs uppercase tracking-[0.2em] text-codex-gold hover:underline"
              >
                🎲 Sortear nome
              </button>
            </div>
            <input
              ...
              className="battle-frame-dim bg-codex-bg px-3 py-2.5 font-garamond text-lg text-codex-ink outline-none focus:border-codex-gold"
            />
          </label>
        </section>

        <section className="mb-8">
          <h2 className="font-cinzel text-xs uppercase tracking-[0.3em] text-codex-inkDim">Povo</h2>
            ...
            {RACE_ORDER.map((option) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-1 font-garamond text-[13px] text-codex-inkDim">{info.temperament}</p>
                  <p className="mt-2 font-garamond text-[15px] italic leading-snug text-codex-ink">
                    &ldquo;{info.creed}&rdquo;
                  </p>
                  <p className="mt-2 font-cinzel text-[13px] tracking-wider text-codex-gold">
        ...
        <section className="mb-8">
          <h2 className="font-cinzel text-[13px] uppercase tracking-[0.3em] text-codex-inkDim">Ordem</h2>
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0">
                      <p
                        className={`font-cinzel text-sm leading-snug tracking-wide ${
                          selected ? "text-codex-goldBright" : "text-codex-ink"
                        }`}
                      >
                        {info.name}
                      </p>
                      <p className="mt-1 font-garamond text-[13px] text-codex-inkDim">{info.role}</p>
                    </div>
                  </div>
                </button>
              );
        ...
        <section className="battle-frame-dim mb-8 p-5">
          <div className="flex items-start gap-4">
            ...
            <div className="min-w-0">
              ...
              <p className="font-garamond text-[13px] text-codex-inkDim">
              ...
              <p className="mt-2 font-garamond text-[15px] leading-snug text-codex-inkDim">{principle.summary}</p>
            </div>
          </div>
          ...
          <div className="mt-4 flex flex-wrap gap-2 border-t border-codex-border/60 pt-4">
            {ATTRIBUTE_KEYS.map((key) => (
              <span
                key={key}
                className="border border-codex-border px-2 py-1 font-cinzel text-[13px] tracking-wider text-codex-ink"
              >
                {key.toUpperCase()} {preview.attributes[key]}
              </span>
            ))}
            <span className="border border-codex-gold/60 px-2 py-1 font-cinzel text-[13px] tracking-wider text-codex-goldBright">
              HP {preview.maxHp}
            </span>
          </div>
        </section>
