...
function CombatLog({ lines }: CombatLogProps) {
  ...
  return (
    <div className="flex h-full flex-col rounded-sm border border-codex-border bg-codex-panel">
      ...
      <div className="flex-1 space-y-1.5 overflow-y-auto px-4 py-3">
        {lines.length === 0 && (
          <p className="font-garamond text-sm italic text-codex-inkDim">A batalha ainda não começou...</p>
        )}
